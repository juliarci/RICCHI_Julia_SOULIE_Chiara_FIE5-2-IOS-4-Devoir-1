...
# trace_full %>% filter(TYPE != "PATIENT")
```
...
La majorité des patients présente un temps de séjour inférieur à 2000 minutes, avec un pic marqué autour de 500 minutes, correspondant au fonctionnement nominal du service pour la plupart des parcours.
Toutefois, la présence de quelques cas extrêmes, avec des durées de séjour atteignant près de 5000 et plus de 6000 minutes, révèle des situations atypiques susceptibles d’indiquer des phénomènes de congestion ou des dysfonctionnements ponctuels du processus.
...
La médiane de ce ratio se situe autour de 40 %, avec une dispersion relativement limitée entre les patients.
...
Enfin, l’étude de la relation entre le temps d’attente et le temps total de séjour met en évidence une corrélation quasi linéaire très forte.
